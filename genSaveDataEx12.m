function saida = genSaveDataEx12()
...
%                             indexM =  m;
%                             indexL = (l-1)*length(k2);
%                             indexK = (k-1)*length(k2)*length(k1);
%                             indexJ = (j-1)*length(k2)*length(k1)*length(b);
%                             indexI = (i-1)*length(k2)*length(k1)*length(b)*length(m2);   
