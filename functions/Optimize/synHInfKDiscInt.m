function outPut = synHInfKDiscInt(A,B2,B1,C,D2,D1,param)
...
%     First column
    ...
    U11 = X-S;
    U21 = X*A0'+L'*B20';
    U31 = zeros(size(C0*X,1),size(U21,2));
    U41 = B10';
    U51 = zeros(size(Xa,1),size(U41,2));
    U61 = zeros(size(Xc,1),size(U51,2));
    U71 = zeros(size(Lb2,1),size(U61,2));
    U81 = zeros(size(Ld2,1),size(U61,2));
    U91 = zeros(size(Ib1,1),size(U81,2));
    U101 = zeros(size(Id1,1),size(U91,2));
