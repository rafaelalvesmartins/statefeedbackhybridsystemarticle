...
%             First time i = j = 1
   ...
   for i=1:nx
       for j=1:nw
            ei = generatesEi(i,nx); 
            productOfDeltaB1Beta1ij = (abs(deltaB1(i,j))^2)*betas1(i,j)*ei*ei';
            
%             First time i = j = 1
            if (i==1 && j == 1) 
                thirdSum = productOfDeltaB1Beta1ij;
            else
                thirdSum = productOfDeltaB1Beta1ij + thirdSum;
            end
            
       end
   end
   
   S = firstSum + secondSum + thirdSum;
...
%             First time i = j = 1
   ...
   for i=1:ny
       for j=1:nw
            ...
            gi = generatesEi(i,ny); 
            productOfDeltaD1Epsilon1ij = (abs(deltaD1(i,j))^2)*epsilons1(i,j)*gi*gi';
            
%             First time i = j = 1
            if (i==1 && j == 1) 
                thirdSum = productOfDeltaD1Epsilon1ij;
            else
                thirdSum = productOfDeltaD1Epsilon1ij + thirdSum;
            end
            
       end
   end
   
   T = firstSum + secondSum + thirdSum;
