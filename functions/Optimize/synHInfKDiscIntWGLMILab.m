...
%   Xa, Lb and Ib1
    ...
    %     Second Column
   lmiterm([-c 2 2 G],1,1,'s'); 
   lmiterm([-c 2 2 X],-1,1); 
   lmiterm([-c 3 2 G],C0,1); 
   lmiterm([-c 3 2 L],D20,1); 
   lmiterm([-c 5 2 Ga],1,1); 
   lmiterm([-c 6 2 Gc],1,1); 
   lmiterm([-c 7 2 Lb2],1,1); 
   lmiterm([-c 8 2 Ld2],1,1); 
...
%        Tenth line
    ...
    if isempty(xopt)
       ...
       outPut.norm = sqrt(dec2mat(LMIs,xopt,mu));
       outPut.G =  dec2mat(LMIs,xopt,G);
